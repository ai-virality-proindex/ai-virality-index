...
const planConfigs: PlanConfig[] = [
  ...
  },
  {
    ...
    ctaAction: { monthly: 'pro_monthly', annual: 'pro_annual' },
  ...
  },
  {
    ...
    ctaAction: { monthly: 'team_monthly', annual: 'team_annual' },
    cta: 'Get started',
    highlight: false,
    badge: null,
  },
      ...
      <div className="mt-20 mx-auto max-w-2xl">
        ...
        <div className="space-y-6">
          {[
            ...
            {
              q: 'What are Notable Changes?',
              a: 'Notable Changes are descriptive observations when a model shows significant activity shifts — spikes, drops, or rank changes. They describe what happened, not predict what will happen next.',
            },
            {
